...
var Conv2D = function (_Layer) {
  ...
  _createClass(Conv2D, [{
    ...
    value: function setWeights(weightsArr) {
      ...
      _get(Conv2D.prototype.__proto__ || Object.getPrototypeOf(Conv2D.prototype), 'setWeights', this).call(this, weightsArr, false);
    ...
    value: function _call_cpu(x) {
      ...
      for (var _n = 0; _n < nbFilter; _n++) {
        ...
        _ndarrayOps2.default.assign(this.output.tensor.pick(null, null, _n), outputChannel.tensor);
      }
